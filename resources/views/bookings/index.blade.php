...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="actions">
                <a href="{{ action('\App\Http\Controllers\BookingController@show', ['booking' => $booking->id]) }}"
                    alt="View" title="View">
                    View
                </a>
                <a href="{{ action('\App\Http\Controllers\BookingController@edit', ['booking' => $booking->id]) }}"
                    alt="Edit" title="Edit">
                    Edit
                </a>
                <form
                    action="{{ action('App\Http\Controllers\BookingController@destroy', ['booking' => $booking->id])}}"
                    method="POST">
                    {{ method_field('DELETE')}}
                    {{ csrf_field() }}
